...
#set_property PACKAGE_PIN U9 [get_ports {addr[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {addr[0]}]
##Bank = 34, Pin name = IO_25_34,							Sch name = SW1
#set_property PACKAGE_PIN U8 [get_ports {addr[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {addr[1]}]
##Bank = 34, Pin name = IO_L23P_T3_34,						Sch name = SW2
#set_property PACKAGE_PIN R7 [get_ports {addr[2]}]					
...
set_property PACKAGE_PIN T8 [get_ports clk_N]					
